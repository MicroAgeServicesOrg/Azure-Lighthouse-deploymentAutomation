...
param name string = 'MicroAge AzMSP Patching Schedule'
...
param tags object = {MicroAge_AzMSP: 'enabled'}
...
resource maintenanceConfiguration_roleAssignments 'Microsoft.Authorization/roleAssignments@2022-04-01' = [for (roleAssignment, index) in (roleAssignments ?? []): {
  name: guid(maintenanceConfig.id, roleAssignment.principalId, roleAssignment.roleDefinitionIdOrName)
  properties: {
